...
## Version 1.5.0 (2026-08-03) - UI优化与GPU配置
...
- **GPU层数配置** 🎮
  ...
  - 默认值 999（全部加载到GPU）
  - 可配置部分加载或纯CPU运行
  - 文件：`MainWindow.xaml`, `MainWindow.xaml.cs`, `ServerConfig.cs`

### 🎨 UI 改进
- **现代化按钮设计** ✨
  - 主窗口底部按钮采用圆角设计（CornerRadius: 8）
  - 统一的白色文字，提高对比度
  - 添加鼠标悬停和点击效果
  - 按钮禁用状态的视觉反馈
  - 底部区域独立 Border 分隔
...
- **Save Profile 对话框优化** 💾
  - 按钮圆角设计（CornerRadius: 6）
  - 优化间距和尺寸，更易点击
  - Save 按钮使用白色文字
  - Cancel 按钮灰色背景，更清晰的视觉层次
  - 修复按钮显示问题
...
- **中文本地化** 🇨🇳
  ...
  - 保留英文快捷键提示
  - 添加英文 ToolTip
  - "启动服务器"、"停止服务器"、"测试连接"、"清空日志"
  - "保存"、"取消"

### 🐛 Bug 修复
- 修复 Save Profile 对话框按钮被裁剪的问题
- 修复 XAML 中 Resources 位置错误

### 📝 技术改进
- 优化按钮样式统一性
- 改进 UI 响应性和交互反馈

## Version 1.4.0 (2026-07-31) - 快捷键和实用工具
...
## Version 1.3.0 (2026-07-29) - UX 增强和参数预设
